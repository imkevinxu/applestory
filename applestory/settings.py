# Django settings for applestory project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'applestory',                      # Or path to database file if using sqlite3.
        'USER': 'applestory_user',                      # Not used with sqlite3.
        'PASSWORD': 'u4HOe8t6zwcFN5dY0ROq2bUCWJYdxE',                  # Not used with sqlite3.
...
SECRET_KEY = 'so0_HRC\qyOmQi&*,.DSKcCg%#F+$WW,J>kwB@dVULdl[<)u`G'
...
ROOT_URLCONF = 'applestory.urls'

WSGI_APPLICATION = 'applestory.wsgi.application'
...
AUTH_PROFILE_MODULE = 'applestory_app.UserProfile'
