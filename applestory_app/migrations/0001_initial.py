...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('applestory_app_userprofile', (
        ...
        db.send_create_signal('applestory_app', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('applestory_app_userprofile')


    models = {
        'applestory_app.userprofile': {
